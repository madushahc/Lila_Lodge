       ...
       className="text-3xl font-bold text-gray-800 mb-16 text-center ">
        ...
        <div className="mt-6 flex justify-center">
          <Link href="/Book">
           ...
           className="px-6 py-3 bg-purple-600 hover:bg-white hover:text-purple-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-100">
              Book Now
            </motion.button>
          </Link>
        </div>
