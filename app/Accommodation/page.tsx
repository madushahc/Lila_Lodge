...
=======
  ...
  return (
    <div className="mb-24">
      ...
      <div className="gap-6 items-center m-3 lg:m-28 item-center p-20">
        <div className="text-center md:text-left space-y-4">
          <h1 className="lg:text-5xl text-4xl font-bold text-gray-800 leading-tight pb-10">
      ...
      className="relative w-full max-w-4xl mx-auto mb-36">
       ...
       className="absolute -bottom-20 right-0 bg-white p-3 shadow-lg rounded-lg z-50 max-w-full sm:max-w-md w-full sm:w-[600px] h-[180px] flex flex-col justify-between transform scale-95 hover:scale-100 transition-transform duration-300 ease-in-out">
