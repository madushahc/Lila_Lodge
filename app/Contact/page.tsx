...
export default function page() {
  return (
    ...
    <head>
        ...
        <meta name="description" content="Get in touch with Lila Lodge for bookings, inquiries, or assistance." />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": {
                ...
                "logo": "https://lila-lodge.vercel.app/logo.png",
                "contactPoint": {
                  "@type": "ContactPoint",
                  "telephone": "+94 71 424 1951",
                  "email": "lilalodgebentota@gmail.com",
