        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center ">
          <div className="transition ease-linear text-center md:text-left space-y-4 lg:m-32">
            ...
            >
              ...
              where comfort meets the lush beauty of Sri Lanka's vibrant
              wilderness. Nestled amidst verdant greenery, our haven is just a
              short stroll from the golden sands of Bentota Beach, offering the
              perfect harmony of nature and relaxation.
            </motion.p>
          </div>
          <motion.div
            initial={{ x: 100, opacity: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                ...
                in the peaceful wilderness ambiance.
              </p>
            </motion.div>
