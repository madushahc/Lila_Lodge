...
<<<<<<< Updated upstream
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="text-center md:text-left space-y-4">
            <h1 className="text-4xl font-bold text-gray-800 leading-tight">Ayubowan !<br></br> Welcome to Lila Lodge, Bentota</h1>
            <h2 className="text-2xl text-gray-600">Bentota’s Hidden Paradise!</h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Escape to serenity at Lila Lodge Guest House, a charming retreat where comfort meets the lush beauty of Sri Lanka's vibrant jungle. 
              Nestled amidst verdant greenery, our haven is just a short stroll from the golden sands of Bentota Beach, offering the perfect harmony 
              of nature and relaxation.
            </p>
          </div>
          <div className="flex justify-center">
            <Image src={img1} width={400} height={600} alt="Lila Lodge" className="rounded-lg shadow-lg object-cover" />
          </div>
        </div>

        {/* Why Choose Lila Lodge Section */}
        <div className="mt-12 bg-white p-8 rounded-lg shadow-xl">
          <h1 className="pb-3 text-3xl font-bold text-center text-gray-800 mb-6">Why Choose Lila Lodge?</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col text-center items-center space-x-4 bg-purple-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
              ...
              <div>
                <h4 className="pt-5 text-xl font-semibold text-gray-700 pb-2">Prime Location</h4>
                <p className="text-lg text-gray-600">Conveniently located just minutes from the beach and Bentota’s top attractions.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col text-center items-center space-x-4 bg-green-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
              ...
              <div>
                <h4 className="pt-5 text-xl font-semibold text-gray-700 pb-2">Natural Setting</h4>
                <p className="text-lg text-gray-600">Wake up to the gentle melodies of birdsong and immerse yourself in the peaceful jungle ambiance.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col text-center items-center space-x-4 bg-blue-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
              ...
              <div>
                <h4 className="pt-5 text-xl font-semibold text-gray-700 pb-2">Authentic Comfort</h4>
                <p className="text-lg text-gray-600">Enjoy cozy, thoughtfully designed rooms crafted for your ultimate relaxation.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col text-center items-center space-x-4 bg-red-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
              ...
              <div>
                <h4 className="pt-5 text-xl font-semibold text-gray-700 pb-2">Warm Hospitality</h4>
                <p className="text-lg text-gray-600">Experience personalized service that reflects the heartwarming spirit of Sri Lanka.</p>
              </div>
            </div>
=======
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center ">
        ...
        <div className="mt-12 bg-white p-8 rounded-lg shadow-xl ">
          ...
          className="pb-3 text-3xl font-bold text-center text-gray-800 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            className="flex flex-col items-center bg-purple-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-100 ease-in-out transform hover:scale-105">
              <FaMapMarkerAlt className="text-3xl text-purple-500" />
         ...
         className="flex flex-col items-center bg-green-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-100 ease-in-out transform hover:scale-105">
              <FaTree className="text-3xl text-green-500" />
         ...
         className="flex flex-col items-center bg-blue-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-100 ease-in-out transform cursor-pointer hover:scale-105">
              <FaBed className="text-3xl text-blue-500" />
         ...
         className="flex flex-col items-center bg-red-100 p-6 rounded-lg shadow-md hover:shadow-xl transition duration-100 ease-in-out transform hover:scale-105">
              <FaHeart className="text-3xl text-red-500" />
...
<<<<<<< Updated upstream
        <div className="text-center md:text-left space-y-4">
    <h1 className="text-4xl font-bold text-gray-800 leading-tight">Explore & Unwind</h1>
    <p className="text-lg text-gray-700 leading-relaxed">
      Start your day with a refreshing walk to the beach or a rejuvenating dip in the ocean. 
      Return to Lila Lodge to relax in our serene garden, surrounded by exotic flora and fauna, where every corner whispers tranquility.<br />
      Whether you're seeking thrilling adventures, blissful serenity, or a perfect blend of both, Lila Lodge Guest House is your gateway to creating unforgettable memories in Bentota.
    </p>
  </div>
...
=======
          <div className="text-center md:text-left space-y-4 lg:m-32">
           ...
           className="text-4xl font-bold text-gray-800 leading-tight">
            ...
            initial={{x:-100,opacity:0}}
            whileInView={{x:0,opacity:1}}
            transition={{delay:0.3,x:{type:"spring", stiffness:50},
            opacity:{duration:1},
            ease:"easeIn",
            duration:1,
          }}
